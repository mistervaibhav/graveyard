...
namespace AppAdvisory.SwitchTheGravity
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1cFTol9NaPiN2xxEsBwOKsu_wwSI_Beu_n1i19TQHp5o/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/tQZ";

		private const string NAME_OF_THE_GAME = "Switch The Gravity";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
