...
import com.apps.developer_cults.euphony.fragments.*
import java.util.*
...
class NavigationDrawerAdapter(_contentList: ArrayList<String>, _getImages: IntArray, _context: Context)
    : androidx.recyclerview.widget.RecyclerView.Adapter<NavigationDrawerAdapter.NavViewHolder>() {
    ...
    * ii) viewType: Int -> The type of the view to be inflated*/
    ...
    class NavViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
