...
import com.apps.developer_cults.euphony.Constants
...
import com.apps.developer_cults.euphony.fragments.MainScreenFragment.Statified.songArtist
import com.apps.developer_cults.euphony.fragments.MainScreenFragment.Statified.songTitle
...
class MainScreenFragment : androidx.fragment.app.Fragment()  {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        /*If there are songs in the device, we display the list*/
            ...
            * Here we are using the Linear layout manager which aligns the objects in a linear way one under the other*/
            val mLayoutManager = androidx.recyclerview.widget.LinearLayoutManager(myActivity)
    ...
    fun bottomBarSetup() {
        try {
            ...
            /*We fetch the song title and song artist
            with the help of the current song helper and set it to the song title in our bottom bar*/
            songTitle?.text = SongPlayingFragment.Statified.currentSongHelper?.songTitle
