...
import com.apps.developer_cults.euphony.adapters.FavoriteAdapter
...
import com.apps.developer_cults.euphony.fragments.FavoriteFragment.Statified.songArtist
import com.apps.developer_cults.euphony.fragments.FavoriteFragment.Statified.songTitle
...
//    }
    ...
    fun bottomBarSetup() {
        try {
            ...
            /*We fetch the song title and song artist with the help of the current song helper and set it to the song title in our bottom bar*/
            songTitle?.text = SongPlayingFragment.Statified.currentSongHelper?.songTitle
