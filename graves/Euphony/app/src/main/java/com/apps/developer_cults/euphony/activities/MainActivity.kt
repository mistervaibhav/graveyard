package com.apps.developer_cults.euphony.activities
...
import com.apps.developer_cults.euphony.adapters.NavigationDrawerAdapter

import com.apps.developer_cults.euphony.R
import com.apps.developer_cults.euphony.fragments.MainScreenFragment
import com.apps.developer_cults.euphony.mNotification
...
import com.apps.developer_cults.euphony.activities.MainActivity.Statified.notify
...
/*Declaring the variable navigation_recycler_view for the list inside the navigation drawer*/
        val navigation_recycler_view = findViewById<androidx.recyclerview.widget.RecyclerView>(R.id.navRecyclerView)
...
/*Here we set a layout manager which aligns the items in a recycler view. As we want to set the items vertically one below the other we use a linear layout manager.*/
        navigation_recycler_view.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(this)
...
/*As the name is suggesting the item animator is used to animate the way the items appear in a recycler view. As we used the default item animator, here we will just see the items
        ...
        navigation_recycler_view.itemAnimator = androidx.recyclerview.widget.DefaultItemAnimator()
